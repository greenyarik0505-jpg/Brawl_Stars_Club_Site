...
const DEFAULT_CLUB_DATA = {
    info: {
        ...
        tag: "#2GLJURYPV",
        description: "Добро пожаловать в наш клуб! Мы — сплочённая команда, которая играет ради удовольствия и побед. Регулярно участвуем в Мегакопилке и Клубной лиге. Будь активным, помогай товарищам и соблюдай правила!",
        requiredTrophies: 25000,
        ownerTelegram: "@yarik_owner"
    },
    members: [
        { id: "1", name: "✨Cesuis✨", role: "Президент", trophies: 62000, avatar: "👑" },
        { id: "2", name: "Zharik🔥", role: "Вице-президент", trophies: 55400, avatar: "🦎" },
        { id: "3", name: "BiBr1k", role: "Вице-президент", trophies: 48900, avatar: "🔥" },
        { id: "4", name: "senyakrud", role: "Вице-президент", trophies: 42000, avatar: "👑" },
        { id: "5", name: "CrowBlade", role: "Ветеран", trophies: 38200, avatar: "🦅" },
        { id: "6", name: "BrawlStar", role: "Ветеран", trophies: 31000, avatar: "⭐" },
        { id: "7", name: "SpikeLove", role: "Участник", trophies: 27500, avatar: "🌵" },
        { id: "8", name: "MortisGod", role: "Участник", trophies: 26800, avatar: "🦇" },
        { id: "9", name: "ColtSheriff", role: "Участник", trophies: 25900, avatar: "🤠" },
        { id: "10", name: "PiperSnipe", role: "Ветеран", trophies: 35200, avatar: "💖" }
    ],
    news: [
        ...
        { id: "2", date: "10.07.2026", title: "📢 Новые критерии вступления", content: "В связи с ростом среднего уровня участников, порог кубков для вступления повышен до 25,000 трофеев. Не сбавляем темп, империя растёт!" },
    ...
    events: [
        ...
        { id: "3", date: "1 Августа 2026", title: "Очистка неактивных", desc: "Ежемесячная проверка логов активности. Игроки, не заходившие в игру более 7 дней без предупреждения, будут кикнуты.", type: "cleanup" },
